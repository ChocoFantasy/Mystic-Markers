const articles = [
  {
    ...
    articleImage: "images/Forum/模糊獵人文章圖.svg",
    interactions: [
      { icon: "images/Forum/Forum_ghost.svg", 
        filledIcon: "images/Forum/solar_ghost-outline.svg",
        count: 1502, 
        altText: "like" },// 按讚數
      { icon: "images/Forum/mynaui_message.svg", count: 465, altText: "message" },// 留言數
      { icon: "images/Forum/Forum_label.svg", count: 600, altText: "label" }, // 收藏數
    ]
  },
  {
    id:2,
    ...
    articleImage: "images/Forum/藤森月子-文章圖.svg",
    interactions: [
      { icon: "images/Forum/Forum_ghost.svg", 
        filledIcon: "images/Forum/solar_ghost-outline.svg",
        count: 102, 
        altText: "like" },
      { icon: "images/Forum/mynaui_message.svg", count: 56, altText: "message" },
      { icon: "images/Forum/Forum_label.svg", count: 78, altText: "label" }
    ]
  },
  {
    id:3,
    ...
    interactions: [
      { icon: "images/Forum/Forum_ghost.svg", 
        ...
        count: 304, 
        altText: "like" },
      { icon: "images/Forum/mynaui_message.svg", count: 15, altText: "message" },
      { icon: "images/Forum/Forum_label.svg", count: 2, altText: "label" }
    ]
  },
  {
    id:4,
    ...
    articleImage: "images/Forum/轉空-文章圖.svg",
    interactions: [
      { icon: "images/Forum/Forum_ghost.svg", 
        filledIcon: "images/Forum/solar_ghost-outline.svg",
        count: 62, 
        altText: "like" },
      { icon: "images/Forum/mynaui_message.svg", count: 65, altText: "message" },
      { icon: "images/Forum/Forum_label.svg", count: 10, altText: "label" }
    ]
  },
  {
    id:5,
    ...
    interactions: [
      { icon: "images/Forum/Forum_ghost.svg", 
        ...
        count: 82, 
        altText: "like" },
      { icon: "images/Forum/mynaui_message.svg", count: 5, altText: "message" },
      { icon: "images/Forum/Forum_label.svg", count: 60, altText: "label" }
    ]
  },
  {
    id:6,
    category: "都市傳說",
    authorName: "莉莉安",
    authorAvatar: "images/Forum/莉莉安.svg",
    ...
    articleImage: "images/Forum/莉莉安文章圖.svg",
    interactions: [
      { icon: "images/Forum/Forum_ghost.svg", 
        filledIcon: "images/Forum/solar_ghost-outline.svg",
        count: 102, 
        altText: "like" },
      { icon: "images/Forum/mynaui_message.svg", count: 85, altText: "message" },
      { icon: "images/Forum/Forum_label.svg", count: 67, altText: "label" }
    ]
  },
  {
    id:7,
    category: "都市傳說",
    authorName: "暗影守望者",
    authorAvatar: "images/Forum/暗影守望者.svg",
    title: "公司廁所半夜傳來的低語聲……",
    ...
    articleImage: "images/Forum/暗影守望者-文章圖.svg",
    interactions: [
      { icon: "images/Forum/Forum_ghost.svg", 
        filledIcon: "images/Forum/solar_ghost-outline.svg",
        count: 28, 
        altText: "like" },
      { icon: "images/Forum/mynaui_message.svg", count: 47, altText: "message" },
      { icon: "images/Forum/Forum_label.svg", count: 60, altText: "label" }
    ]
  },
  {
    ...
    articleImage: "images/Forum/黑夜行者-文章圖.svg",
    interactions: [
      { icon: "images/Forum/Forum_ghost.svg", 
        filledIcon: "images/Forum/solar_ghost-outline.svg",
        count: 502, 
        altText: "like" },
      { icon: "images/Forum/mynaui_message.svg", count: 46, altText: "message" },
      { icon: "images/Forum/Forum_label.svg", count: 8, altText: "label" }
    ]
  },
  {
    id:9,
    ...
    interactions: [
      { icon: "images/Forum/Forum_ghost.svg", 
        ...
        altText: "like" },
      { icon: "images/Forum/mynaui_message.svg", count: 5, altText: "message" },
      { icon: "images/Forum/Forum_label.svg", count: 9, altText: "label" }
    ]
  },
  {
    id:10,
    ...
    interactions: [
      { icon: "images/Forum/Forum_ghost.svg", 
        ...
        altText: "like" },
      { icon: "images/Forum/mynaui_message.svg", count: 15, altText: "message" },
      { icon: "images/Forum/Forum_label.svg", count: 600, altText: "label" }
    ]
  },
