const articles = [
  ...
  },
  {
    ...
    isFavorite: false,
    articleImage: "images/Forum/Tsukiko-Fujimori-text.png",
    interactions: [
      {
        icon: "images/Forum/Forum_ghost.svg",
        filledIcon: "images/Forum/solar_ghost-outline.svg",
  ...
  },
  {
    ...
    isFavorite: false,
    articleImage: "images/Forum/Turn-empty-article.png",
    interactions: [
      {
        icon: "images/Forum/Forum_ghost.svg",
        filledIcon: "images/Forum/solar_ghost-outline.svg",
  ...
  },
  {
    ...
    isFavorite: false, // 是否收藏
    articleImage: "images/Forum/Night-Explorer-Articles.png",
    interactions: [
      {
        icon: "images/Forum/Forum_ghost.svg",
        filledIcon: "images/Forum/solar_ghost-outline.svg",
  ...
  },
  {
    ...
    isFavorite: false, // 是否收藏
    articleImage: "images/Forum/hunter-article-picture.png",
    interactions: [
      {
        icon: "images/Forum/Forum_ghost.svg",
        filledIcon: "images/Forum/solar_ghost-outline.svg",
...

  {
    ...
    articleImage: "images/Forum/Lillian-article.png",
    interactions: [
      {
        icon: "images/Forum/Forum_ghost.svg",
        filledIcon: "images/Forum/solar_ghost-outline.svg",
